...
export const APP_CONFIG = {
  ...
  APP_DESCRIPTION:
    "Connect, learn, and grow together with our live class platform. Host or join interactive sessions with HD video, real-time chat, and seamless collaboration.",
  ...
  HOME_CONTENT: {
    ...
    FEATURES: {
      ...
      DESCRIPTION:
        "Powerful features designed to make your live sessions engaging and productive",
    },
    BENEFITS: {
      HEADING: "Why Choose {APP_NAME}?",
      DESCRIPTION:
        "Experience the best-in-class platform for hosting and joining live interactive sessions.",
    },
    CTA: {
      HEADING: "Ready to Start Your First Session?",
      DESCRIPTION:
        "Join thousands of users who are already using {APP_NAME} for their online sessions.",
